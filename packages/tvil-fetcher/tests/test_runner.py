...
from tvil_core.enums import FetchStatus, SourceKind, TitleKind
from tvil_core.models import Source
from tvil_core.settings import Settings, SourceConfig
from tvil_fetcher.daemon import _parse_time, run_once
from tvil_fetcher.http import HttpClient
from tvil_fetcher.runner import sync_all
...
class TestRunOnce:
    def test_a_failing_phase_does_not_propagate(
        ...
        monkeypatch.setattr("tvil_fetcher.daemon.sync_all", explode)
        monkeypatch.setattr("tvil_fetcher.daemon.require_schema", lambda *_a: None)
