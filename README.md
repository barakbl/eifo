...
[![tests](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fbarakbl%2Ftvil%2Fmain%2F.github%2Fbadges%2Ftests.json)](https://github.com/barakbl/tvil/actions/workflows/ci.yml)
...
[`docs.internal/11-ops-install.md`](docs.internal/11-ops-install.md).
...
| `docs.internal/` | The specifications, written before the code |
...
[`docs.internal/05-fetcher.md`](docs.internal/05-fetcher.md) has the details.

### Adding a ratings provider

Same shape, in `enrichers/`: add a `RatingProvider` enum member, a weight in
`[scores.weights]`, and the enricher. See `docs.internal/06-enrichment.md`.
...
Read [`docs.internal/10-quality.md`](docs.internal/10-quality.md) before your first PR;
it is short.
