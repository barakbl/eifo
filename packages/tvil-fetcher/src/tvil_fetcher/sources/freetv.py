...
logger = logging.getLogger("tvil.fetch.source.freetv")
...
#: ``type`` values the API uses for the two things TVIL tracks.
_KIND_BY_TYPE = {"VOD": TitleKind.MOVIE, "SERIAL": TitleKind.SERIES}

#: Poster preference: the closest to TVIL's 2:3 card first, widescreen last.
