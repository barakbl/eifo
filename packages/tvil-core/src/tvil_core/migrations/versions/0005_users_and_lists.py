...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("last_login_at", tvil_core.types.UtcDateTime(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("created_at", tvil_core.types.UtcDateTime(), nullable=False),
        sa.Column("expires_at", tvil_core.types.UtcDateTime(), nullable=False),
        sa.Column("last_used_at", tvil_core.types.UtcDateTime(), nullable=False),
