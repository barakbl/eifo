...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created_at", tvil_core.types.UtcDateTime(), nullable=False),
        sa.Column("updated_at", tvil_core.types.UtcDateTime(), nullable=False),
        sa.CheckConstraint(
    ...
    op.create_table(
        ...
        sa.Column("deactivated_at", tvil_core.types.UtcDateTime(), nullable=True),
        sa.Column("created_at", tvil_core.types.UtcDateTime(), nullable=False),
        sa.Column("updated_at", tvil_core.types.UtcDateTime(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("first_seen", tvil_core.types.UtcDateTime(), nullable=False),
        sa.Column("last_seen", tvil_core.types.UtcDateTime(), nullable=False),
        sa.Column("gone_since", tvil_core.types.UtcDateTime(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("started_at", tvil_core.types.UtcDateTime(), nullable=False),
        sa.Column("finished_at", tvil_core.types.UtcDateTime(), nullable=True),
        sa.Column(
            "status",
            sa.Enum(
                "ok",
    ...
    op.create_table(
        ...
        sa.Column("created_at", tvil_core.types.UtcDateTime(), nullable=False),
        sa.Column("resolved_at", tvil_core.types.UtcDateTime(), nullable=True),
